...
console.log('BitCore Service native interface vs. BitcoinSubsidium JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.BitcoinSubsidium',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('BitcoinSubsidium started');
});

bitcoind.on('ready', function() {

  console.log('BitcoinSubsidium ready');
